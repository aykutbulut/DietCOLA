...
// Default Constructor
DcBranchDefaultDecision::DcBranchDefaultDecision()
    :
    DcBranchDecision()
{
    model_ = NULL;
...
// Copy constructor
DcBranchDefaultDecision::DcBranchDefaultDecision (
    const DcBranchDefaultDecision & rhs)
    :
    DcBranchDecision()
{
    model_ = rhs.model_;
...
// Clone
DcBranchDecision *
DcBranchDefaultDecision::clone() const
{
    return new DcBranchDefaultDecision(*this);
}

// Initialize i.e. before start of choosing at a node
void
DcBranchDefaultDecision::initialize(DcModel * model)
{
    model_ = model;
    bestCriterion_ = 0.0;
    bestChangeUp_ = 0.0;
...
int
DcBranchDefaultDecision::betterBranch(int thisOne, int bestSoFar,
...
void
DcPseudocost::update(const int dir,

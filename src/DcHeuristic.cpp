...
// Default Constructor
DcHeuristic::DcHeuristic()
    :model_(NULL)
{
}

// Constructor from model
DcHeuristic::DcHeuristic(DcModel & model)
{
    model_ = &model;
}
...
// update model
void DcHeuristic::setModel(DcModel * model)
{
    model_ = model;
}

// Default Constructor
DcRounding::DcRounding()
    :DcHeuristic()
{
...
// Constructor from model
DcRounding::DcRounding(DcModel & model)
    :DcHeuristic(model)
{
    assert(model.solver());
}
...
// Clone
DcHeuristic *
DcRounding::clone() const
{
    return new DcRounding(*this);
}

// Copy constructor
DcRounding::DcRounding(const DcRounding & rhs)
    :
    DcHeuristic(rhs),
    matrix_(rhs.matrix_),
...
int
DcRounding::solution(double & solutionValue,
		      double * betterSolution)
{
    ...
    //model_->getDblParam(DcModel::DcIntegerTolerance);
	...
	if (newSolutionValue < solutionValue) {
		...
		// Can easily happen
		//printf("Debug DcRounding giving bad solution\n");
	    }
	}
    }
    delete [] newSolution;
...
// update model
void DcRounding::setModel(DcModel * model)
{
    model_ = model;
    // Get a copy of original matrix (and by row for rounding);

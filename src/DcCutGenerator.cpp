...
// Normal constructor
DcCutGenerator::DcCutGenerator(DcModel * model,CglCutGenerator * generator,
...
// Copy constructor
DcCutGenerator::DcCutGenerator ( const DcCutGenerator & rhs)
{
    model_ = rhs.model_;
...
*/
void
DcCutGenerator::refreshModel(DcModel * model)
{
    model_ = model;
    //generator_->refreshSolver(model_->solver());
}
...
*/
bool
DcCutGenerator::generateCuts( OsiCuts & cs , bool fullScan)
{
...
void
DcCutGenerator::setHowOften(int howOften)
{
    if (howOften >= 1000000) {
